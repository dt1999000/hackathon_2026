...
export class ChatService {
     ...
     */
    public static research<ThrowOnError extends boolean = true>(options: Options<chatResearchData, ThrowOnError>) {
        return (options.client ?? client).post<chatResearchResponses, chatResearchErrors, ThrowOnError>({
            responseType: 'json',
            security: [{ scheme: 'bearer', type: 'http' }],
